...
const _require = require(`./plugin-options`),
      createPluginConfig = _require.createPluginConfig,
      validateOptions = _require.validateOptions;

const _require2 = require(`./download-contentful-assets`),
      downloadContentfulAssets = _require2.downloadContentfulAssets;
